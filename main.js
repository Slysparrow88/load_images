const BASE_USR = "https://api.unsplash.com/photos";
const CLIENT_ID =
  "ca5a2a324ba06f2cf8bede88a989bb6c2f5f87730032b3c6256b72888f2cc94c";

const Request = {
  baseUrl: `${BASE_USR}?client_id=${CLIENT_ID}`,

  listFotos: function (limit, page) {
...
function Gallery({ limit, page, gallery_id, nav_id }) {
  this.fotos = [];
  this.page = page;
  this.limit = limit;
